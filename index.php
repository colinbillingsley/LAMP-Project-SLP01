...
<html lang="en">
    ...
    <header>
        <nav class="top-nav-bar">
            ...
            <a href="index.html" class="top-nav-bar-logo">POKEMON MANAGER</a>
    ...
    <body>
        <div class="text-box-container">
            <div class="text-box">
                <h1 class="main-name-heading">Welcome to the Pokemon Manager</h1>
            </div>
        </div>

        <ul class="body-btns-container">
            <!-- log in button -->
            <li>
                <a href="login.html" class="button"> 
                    <svg class="pointer" width="13" height="13" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Group 1">
